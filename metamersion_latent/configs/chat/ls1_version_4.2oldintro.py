...
# Used Thursday Jan 26 LS1 for Entrance Terminal
#######################################################################################################################
...
last_bot_pre_message_injection = f"""\nThis was enough information for the {ai_prefix}. In the next statement, the {ai_prefix} politely thanked the {human_prefix} and said that the VR experience can now begin in the next room. For this, the person needs to go to the next room and sit down and wait."""
